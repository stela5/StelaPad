...
// !! BUG FIX !! VML doesn't apply scale transform to stroke (see http://bugs.dojotoolkit.org/ticket/14558)
var matrix = this._getRealMatrix();
if (!this.ranOnce && this.strokeStyle && matrix && matrix.xx && matrix.xx !== 1 && matrix.yy && matrix.xx === matrix.yy) {
	this.strokeStyle.width = Math.floor(this.strokeStyle.width * matrix.xx);
	this.ranOnce = true;
	this.setStroke(this.strokeStyle);
}
