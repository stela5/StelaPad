...
// modified February 2012 - Stela 5
...
class UploadHandler
{
    ...
    function __construct($options=null) {
        $this->options = array(
            ...
            'max_file_size' => null,
            'min_file_size' => 1,
'accept_file_types' => '/\.json$/i',	// file upload only used for JSON projects
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error) {
        ...
        if (!$error && $file->name) {
$file->name = uniqid('project-', true).'.json';	// rename with unique filename
...
return null;	// delete not supported
        }
